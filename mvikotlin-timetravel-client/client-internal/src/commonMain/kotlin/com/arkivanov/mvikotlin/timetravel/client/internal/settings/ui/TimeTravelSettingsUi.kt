package com.arkivanov.mvikotlin.timetravel.client.internal.settings.ui
...
fun TimeTravelSettingsUi(component: TimeTravelSettings) {
    val editing: Model.Editing? = component.models.value.editing
